...
const PROD = "http://srvpiqas.emaapq.local:50000/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_INTRANET_QAS&receiverParty=&receiverService=&interface=SI_EstrucOrgEmpleados_Req&interfaceNamespace=urn:epmaps.com:INTRANET:ERP:EstrucOrgEmpleados";
const WSDL_URL =
